...
var MHRI = 1; // row number -1 to allow for an index
...
function PD(PDNorPDC) {
    ...
    if (!retVal) { retVal = PDNs[PDCs.indexOf(PDNorPDC)]; }
...
function SVS_FOLDER_ID() {
    var retVal = {
        ...
        //   ,done:SS.getRangeByName('settings_SVSdoneFolder').getValue().toString()
    };
    return retVal;
}
...
/* Useful stuff */
var alphaCols = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L'
...
// used on PO / PR
var H_IDESC = 'Item Description'; var H_ICODE = 'Item Code';
...
var H_USAGE = 'Usage'; var H_TEAM = 'Team';

// used on PO / PR
var H_QTY = 'Qty'; var H_PUOM = 'Purchase UoM'; var H_FACTOR = 'Factor'; var H_BUOM = 'Base UoM'; var H_UNIT = 'Unit Cost';

var H_NET = 'Net Cost'; var H_VATRATE = 'VAT Rate'; var H_VATVALUE = 'VAT'; var H_LINEVALUE = 'Total';

var H_PDN = 'Project Dimension'; var H_PDC = 'PD Code';

// order details
var H_SUPPLIER = 'Supplier'; var H_EMERGENCY = 'Emergency Order'; var H_ACTDEL = 'Delivery to Site Date'; var H_OFF = 'Off Hire Date (if Hire)';
var H_PONUM = 'Auto generated PR Or PO Number'; var H_POCREATED = 'Auto Date Order Created';
var H_BRANCHPO = 'Branch PO Number\n(link to SVS)'; var H_BRANCHLINE = 'Branch PO Line number'; var H_BRANCHSUPPLIER = 'Branch PO Supplier';

var H_STATUS = 'Order Status';

var ITEMREADY_PREFIX = 2; // prefix allowing an item to be added to a WT50 or BPR
var REGEN_PREFIX = 3; // prefix allowing regen from central dropdowns
var EXPECTINGSVS_PREFIX = 4; // prefix showing that an SVS is expected
var VOID_PREFIX = 8; // void prefix - status prefix greater than or equal to this voids the item
...
// delivery details
var H_QTYRCVD = 'Qty Received'; var H_QTYLEFT = 'Sum Left to deliver'; var H_DATEDELIVERED = 'Date Delivered';
var H_STORED = 'Store location'; var H_DELCOMMENTS = 'Delivery queries or notes about paying';

// hire items
var H_HIRESTATUS = 'Hire Status';
var H_ONHIRE = 'Date delivered to site'; var H_OFFHIRE = 'Off hire date';
